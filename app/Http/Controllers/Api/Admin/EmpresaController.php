...
//REvisdar este cidigo
class EmpresaController extends Controller
{
    public function index(){
        $data = Empresa::orderBy("orden")->get(["id", "nombre"]); // Corregido "ordenBy" a "orderBy"
    ...
    public function destroy($id){
        $data = Empresa::find($id);
        $data->delete();
        return response()->json("Empresa borrado", 200);
    }
}
